# AI Usage Policy — GTm StarT Fork
...
This policy applies to all contributors to GTm StarT Fork, developers, dev helpers and community contributors alike, and to any generative AI tool (LLM chat assistants, AI code completion/autocomplete, AI refactoring or documentation tools, etc.).
